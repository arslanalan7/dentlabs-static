...
const stats = [
  { label: 'Hasta Memnuniyeti', value: '90%' },
  { label: 'Zamanında Teslimat', value: '95%' },
  { label: 'Hekim Tavsiye Oranı', value: '100%' },
];
  ...
  return (
    <section className="bg-white dark:bg-gray-900 py-24 px-4">
      <div className="max-w-6xl mx-auto text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 dark:text-white">Dentaverax Başarı Oranları</h2>
